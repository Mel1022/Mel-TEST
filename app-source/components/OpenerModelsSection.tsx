...
const MODELS = [
  ...
  },
  {
    ...
    price: "$1,349",
    features: ["Chain drive", "¾ HP motor", "Lifetime motor warranty"],
    image: "/images/2420L_1.png",
    brochure: "/brochures/2420L_product_guide.pdf",
  },
  {
    tag: "Entry Belt-Drive · Smart",
    name: "LiftMaster 4690L",
    subtitle: "Belt-drive · myQ Wi-Fi built-in · Quiet attached garages",
    price: "$1,424",
    features: ["Belt drive — quiet", "Built-in myQ Wi-Fi", "Smartphone control"],
    image: "/images/4690L_1.png",
  ...
  },
  {
    ...
    price: "$1,624",
    features: ["Belt drive — ultra quiet", "Built-in Wi-Fi", "Battery backup", "Enhanced camera"],
    image: "/images/6690L_1.png",
    brochure: "/brochures/6690L_product_guide.pdf",
  },
  {
    tag: "Wall Mount",
