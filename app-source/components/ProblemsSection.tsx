              ...
              >
                <div className="rounded-card border border-steel/10 bg-white shadow-card h-full flex flex-col p-7 pstack-card-inner relative overflow-hidden">
                    ...
                    <>
                      <div
                        ...
                        style={{
                          ...
                          backgroundImage: i === 0 ? "url(/images/garage-door-wont-open.webp)" : i === 1 ? "url(/images/garage-door-grinding.jpg)" : i === 2 ? "url(/images/garage-door-off-track.jpg)" : i === 3 ? "url(/images/garage-door-spring.jpg)" : i === 4 ? "url(/images/garage-door-opener.jpg)" : "url(/images/garage-door-slow.webp)",
                  ...
                  <div className="flex items-center gap-3 mb-5" aria-hidden="true">
                    <span className={`text-[10px] font-extrabold uppercase tracking-[0.2em] ${i <= 5 ? "text-white/60" : "text-navy/45"}`}>
                      {String(i + 1).padStart(2, "0")}&nbsp;/&nbsp;{String(PROBLEMS.length).padStart(2, "0")}
                    </span>
                    <span className={`flex-1 h-px ${i <= 5 ? "bg-white/20" : "bg-navy/8"}`} />
                  </div>

                  {/* Icon */}
                  <span className={`inline-flex items-center justify-center w-11 h-11 rounded-full mb-4 flex-shrink-0 ${i <= 5 ? "bg-white/15 text-white" : "bg-navy/8 text-navy"}`}>
                    {p.icon}
                  </span>

                  {/* Title */}
                  <h3
                    className={`font-heading font-extrabold mb-3 ${i <= 5 ? "text-white" : "text-navy-dark"}`}
                  ...
                  {/* Body */}
                  <p className={`text-sm leading-relaxed flex-1 ${i <= 5 ? "text-white/80" : "text-steel"}`}>
                    {p.body}
                  </p>
                  ...
                  <button
                    ...
                    className={`mt-5 self-start inline-flex items-center gap-2 text-sm font-bold transition-colors duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 rounded ${i <= 5 ? "text-white hover:text-white/80 focus-visible:ring-white" : "text-navy hover:text-navy-dark focus-visible:ring-navy"}`}
                  >
                    Get Help
                    <span className="inline-block transition-transform duration-200 group-hover:translate-x-1">→</span>
                  </button>
