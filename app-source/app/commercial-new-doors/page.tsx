  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/commercial-new-doors-bg.png')", backgroundSize: "cover", backgroundPosition: "center" }}
      >
      ...
      <section className="bg-white py-14 sm:py-16 overflow-hidden">
        ...
        <div className="overflow-hidden">
          <div className="brand-marquee flex gap-6" style={{ width: "max-content" }}>
            {[
              { src: "/images/logo-steelcraft.png", alt: "Steelcraft" },
              { src: "/images/logo-doorcraft.png", alt: "Door Craft" },
              { src: "/images/logo-garaga.png", alt: "Garaga" },
              { src: "/images/logo-clopay.png", alt: "Clopay" },
              { src: "/images/logo-amarr.png", alt: "Amarr" },
              ...
              { src: "/images/logo-steelcraft.png", alt: "Steelcraft 2" },
              { src: "/images/logo-doorcraft.png", alt: "Door Craft 2" },
              { src: "/images/logo-garaga.png", alt: "Garaga 2" },
              { src: "/images/logo-clopay.png", alt: "Clopay 2" },
              { src: "/images/logo-amarr.png", alt: "Amarr 2" },
