...
const OpenerHero = (
  <section style={{ position: "relative", overflow: "hidden", backgroundImage: "url('/images/opener-hero-bg.png')", backgroundSize: "160% auto", backgroundPosition: "30% center" }} className="bg-navy-dark text-white">
